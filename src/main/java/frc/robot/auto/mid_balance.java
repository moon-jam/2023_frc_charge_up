...
// public class mid_balance extends PathPlannerModule {
...
//     public mid_balance(SwerveSubsystem swerve, IntakeSubsystem intake, RackSubsystem rack,
...
//         List<PathPlannerTrajectory> trajectory = PathPlanner.loadPathGroup("middle_balance",
...
//                 new InstantCommand(() -> this.intake.putCon()).withTimeout(1.5),
//                 autoDrive1.alongWith(reset.withTimeout(2.5)),
